...
class CliTestCase(unittest.TestCase):
    ...
    def test_validate(self):
        ...
        with capturer.CaptureOutput(merged=False, relay=False) as captured:
            with __main__.App(argv=['validate', 'bmp2_a + bmp2_a | x-link: [l-bond-atom: bmp2_a(1)-362S1 | l-displaced-atom: bmp2_a(1)-362H1 | r-bond-atom: bmp2_a(2)-362S1 | r-displaced-atom: bmp2_a(2)-362H1]']) as app:
                # run app
                app.run()
        ...
        with self.assertRaisesRegex(SystemExit, '^Form is invalid'):
            with __main__.App(argv=['validate', 'abc_a + abc_b | x-link: [l-bond-atom: abc_c(1)-2O1 | l-displaced-atom: abc_d(1)-2H1 | r-bond-atom: abc_b(1)-3C1 | r-displaced-atom: abc_b(1)-3H1 | r-displaced-atom: abc_b(1)-3O1]']) as app:
                app.run()
    ...
    def test_get_formula(self):
        ...
        with capturer.CaptureOutput(merged=False, relay=False) as captured:
            with __main__.App(argv=['get-formula', 'abc_a + abc_b | x-link: [l-bond-atom: abc_a(1)-2O1 | l-displaced-atom: abc_a(1)-2H1+1 | r-bond-atom: abc_b(1)-3C1 | r-displaced-atom: abc_b(1)-3H1 | r-displaced-atom: abc_b(1)-3O1]', '{abc_a:C5H10O, abc_b:C3H5O}']) as app:
                # run app
                app.run()
        ...
        with self.assertRaisesRegex(SystemExit, '^Form is invalid'):
            with __main__.App(argv=['get-formula', 'abc_a + abc_b | x-link: [l-bond-atom: abc_c(1)-2O1 | l-displaced-atom: abc_d(1)-2H1 | r-bond-atom: abc_b(1)-3C1 | r-displaced-atom: abc_b(1)-3H1 | r-displaced-atom: abc_b(1)-3O1]', '{abc_a:C5H10O, abc_b:C3H5O}']) as app:
                app.run()
    ...
    def test_get_mol_wt(self):
        ...
        with capturer.CaptureOutput(merged=False, relay=False) as captured:
            with __main__.App(argv=['get-molwt', 'abc_a + abc_b | x-link: [l-bond-atom: abc_a(1)-2O1 | l-displaced-atom: abc_a(1)-2H1+1 | r-bond-atom: abc_b(1)-3C1 | r-displaced-atom: abc_b(1)-3H1 | r-displaced-atom: abc_b(1)-3O1]', '{abc_a:86, abc_b:57}']) as app:
                # run app
                app.run()
        ...
        with self.assertRaisesRegex(SystemExit, '^Form is invalid'):
            with __main__.App(argv=['get-molwt', 'abc_a + abc_b | x-link: [l-bond-atom: abc_c(1)-2O1 | l-displaced-atom: abc_d(1)-2H1 | r-bond-atom: abc_b(1)-3C1 | r-displaced-atom: abc_b(1)-3H1 | r-displaced-atom: abc_b(1)-3O1]', '{abc_a:86, abc_b:57}']) as app:
                app.run()
    ...
    def test_get_charge(self):
        ...
        with capturer.CaptureOutput(merged=False, relay=False) as captured:
            with __main__.App(argv=['get-charge', 'abc_a + abc_b | x-link: [l-bond-atom: abc_a(1)-2O1 | l-displaced-atom: abc_a(1)-2H1+1 | r-bond-atom: abc_b(1)-3C1 | r-displaced-atom: abc_b(1)-3H1 | r-displaced-atom: abc_b(1)-3O1]', '{abc_a:-1, abc_b:0}']) as app:
                # run app
                app.run()
        ...
        with self.assertRaisesRegex(SystemExit, '^Form is invalid'):
            with __main__.App(argv=['get-charge', 'abc_a + abc_b | x-link: [l-bond-atom: abc_c(1)-2O1 | l-displaced-atom: abc_d(1)-2H1 | r-bond-atom: abc_b(1)-3C1 | r-displaced-atom: abc_b(1)-3H1 | r-displaced-atom: abc_b(1)-3O1]', '{abc_a:-1, abc_b:0}']) as app:
                app.run()
